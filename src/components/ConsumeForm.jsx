...
export default function ConsumeForm({ setFoodLog, toggleModal }) {
  ...
  return (
    <div className='fixed inset-0 w-[1000vh] height-[100vh] z-50'>
      ...
      <div className='modal-content w-[400px] md:w-[500px] shadow-innerborder overflow-clip bg-slate-100 rounded-lg px-6 py-6'>
...

        {
          (nutrition && showNutrition) && (
            ...
            <div onClick={() => setShowNutrition(false)} className='fixed inset-0 w-[1000vh] height-[100vh] bg-modal z-100'></div>
              <div className='modal-content w-[400px] md:w-[500px] shadow-innerborder overflow-clip border border-green2 bg-slate-100 rounded-lg px-6 py-6 text-green1'>
