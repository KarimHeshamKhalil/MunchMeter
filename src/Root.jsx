...
export default function Root() {
  ...
  return (
    <div>
      ...
      <div className='flex items-center justify-center checkPoint1:justify-between flex-col-reverse gap-16 checkPoint1:flex-row-reverse px-16 h-[110vh] text-center checkPoint1:text-left text-green1 bg-slate-100 relative'>
      ...
      <div className='relative'>
        <div className='px-4 checkPoint2:px-12 py-16 mb-4 bg-slate-100 flex flex-col checkPoint2:flex-row items-center justify-center checkPoint2:justify-between'>
          <div className='px-6 py-6 rounded-md bg-slate-100 relative hover:-translate-y-4 hover:shadow-card transition-all duration-200'>
            <h3 className='text-2xl checkPoint2:text-3xl font-medium mb-3 text-green1 flex items-center gap-2 rubik'><MdFeedback /> Collecting Feedback</h3>
            <p className='max-w-[450px] bigCheckPoint:max-w-[600px] text-lg checkPoint2:text-xl text-green1'>
        ...
        <div className='px-4 checkPoin2:px-12 py-16 mb-4 bg-slate-100 flex flex-col checkPoint2:flex-row-reverse items-center justify-center checkPoint2:justify-between'>
          <div className='px-6 py-6 rounded-md bg-slate-100 relative hover:-translate-y-4 hover:shadow-card transition-all duration-200'>
            <h3 className='text-2xl checkPoint2:text-3xl font-medium mb-3 text-green1 flex items-center gap-2 rubik'><MdFeedback />Identifying Problems</h3>
            <p className='max-w-[450px] bigCheckPoint:max-w-[600px] text-lg checkPoint2:text-xl text-green1'>
        ...
        <div className='px-4 checkPoint2:px-12 py-16 bg-slate-100 items-center justify-center flex flex-col checkPoint2:flex-row checkPoint2:justify-between mb-12'>
          <div className='px-6 py-6 rounded-md bg-slate-100 relative hover:-translate-y-4 hover:shadow-card transition-all duration-200'>
            <h3 className='text-2xl checkPoint2:text-3xl font-medium mb-3 text-green1 flex items-center gap-2 rubik'><FaLightbulb />Best Solution</h3>
            <p className='max-w-[450px] bigCheckPoint:max-w-[600px] text-lg checkPoint2:text-xl text-green1'>
